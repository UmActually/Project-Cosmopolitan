                ...
                ForEach($arrowItems) { $item in
                    Section(header: HStack {
                        Button(action: {
                            ...
                            Image(systemName: item.isExpanded ? "arrow.down.circle.fill" : "arrow.right.circle")
                                .resizable()
